...
class _ReproductorAlbumScreenState extends State<ReproductorAlbumScreen> {
  late int albumId;
  ...
  void initState() {
    ...
    albumId = widget.playbackData['albumId'];
    albumTitle = widget.playbackData['albumTitle'];
    albumArtist = widget.playbackData['albumArtist'];
    coverUrl = widget.playbackData['coverUrl'];
    isAsset = widget.playbackData['isAsset'];
    currentTrackIndex = widget.playbackData['trackIndex'];
    tracks = List<Map<String, dynamic>>.from(widget.playbackData['tracks']);
  ...
  void _updateCurrentTime() {
    ...
    int totalSeconds = (int.parse(parts[0]) * 60) + int.parse(parts[1].split(' ')[0]);
  ...
  void _playPreviousTrack() {
    setState(() {
      ...
      // Actualizar el estado de favorito según la pista actual
