...
class AlbumPrincipal extends StatefulWidget {
  ...
  @override
  State<AlbumPrincipal> createState() => _AlbumPrincipalState();
}

class _AlbumPrincipalState extends State<AlbumPrincipal> {
  int _selectedIndex = 1;
  int _selectedTabIndex = 1; // Comenzamos con ALBUMS seleccionado
  ...
  final List<AlbumItem> _allAlbums = [
    ...
    AlbumItem(
      ...
      'assets/MUSICOTERAPIA/img_album2.jpg',
      2,
      artist: 'Colección Jazz',
      songs: [
        Song('Take Five', 'Dave Brubeck', 'assets/MUSICOTERAPIA/img_album2.jpg', '5:24'),
        Song('So What', 'Miles Davis', 'assets/MUSICOTERAPIA/img_album2.jpg', '9:22'),
        Song('Fly Me To The Moon', 'Frank Sinatra', 'assets/MUSICOTERAPIA/img_album2.jpg', '3:10'),
    ...
    AlbumItem(
      ...
      'assets/MUSICOTERAPIA/img_album4.jpg',
      4,
      artist: 'Mindfulness Masters',
      songs: [
        Song('Respiración Consciente', 'Mindfulness', 'assets/MUSICOTERAPIA/img_album4.jpg', '15:20'),
        Song('Paz Interior', 'Serenity Now', 'assets/MUSICOTERAPIA/img_album4.jpg', '12:45'),
        Song('Visualización Positiva', 'Inner Journey', 'assets/MUSICOTERAPIA/img_album4.jpg', '18:30'),
        Song('Gratitud y Presencia', 'Present Moment', 'assets/MUSICOTERAPIA/img_album4.jpg', '10:15'),
      ],
    ),
    ...
    AlbumItem(
      ...
      'assets/MUSICOTERAPIA/img_album5.jpg',
      5,
      artist: 'Ambient Collective',
      songs: [
        Song('Focus Flow', 'Ambient Masters', 'assets/MUSICOTERAPIA/img_album5.jpg', '8:40'),
        Song('Deep Work', 'Concentration Sounds', 'assets/MUSICOTERAPIA/img_album5.jpg', '11:25'),
        Song('Calma Productiva', 'Productive Mood', 'assets/MUSICOTERAPIA/img_album5.jpg', '9:15'),
        Song('Espacio Mental', 'Clear Mind', 'assets/MUSICOTERAPIA/img_album5.jpg', '12:50'),
    ...
    AlbumItem(
      'Piano Instrumental',
      'Música para el alma',
      'assets/MUSICOTERAPIA/img_album7.jpg',
      7,
      artist: 'Piano Dreams',
      songs: [
        Song('Lluvia de Estrellas', 'Piano Dreams', 'assets/MUSICOTERAPIA/img_album7.jpg', '4:50'),
        Song('Memorias', 'Soul Piano', 'assets/MUSICOTERAPIA/img_album7.jpg', '5:25'),
        Song('Atardecer', 'Peaceful Keys', 'assets/MUSICOTERAPIA/img_album7.jpg', '6:10'),
        Song('Camino de Luz', 'Piano Journey', 'assets/MUSICOTERAPIA/img_album7.jpg', '7:35'),
      ],
    ),
    AlbumItem(
      ...
      artist: 'Sleep Well',
      songs: [
        Song('Nana Nocturna', 'Sweet Dreams', 'assets/MUSICOTERAPIA/img_album8.jpg', '8:20'),
        Song('Arrullo Celestial', 'Night Sleep', 'assets/MUSICOTERAPIA/img_album8.jpg', '9:45'),
        Song('Sueños Tranquilos', 'Sleep Well', 'assets/MUSICOTERAPIA/img_album8.jpg', '11:30'),
        Song('Descanso Profundo', 'Deep Rest', 'assets/MUSICOTERAPIA/img_album8.jpg', '12:15'),
      ],
    ),
    ...
    AlbumItem(
      ...
      'assets/MUSICOTERAPIA/img_album9.jpg',
      9,
      artist: 'Sacred Sounds',
      songs: [
        Song('Om Shanti', 'Sacred Sounds', 'assets/MUSICOTERAPIA/img_album9.jpg', '10:15'),
        Song('Mantra Sanador', 'Ancient Wisdom', 'assets/MUSICOTERAPIA/img_album9.jpg', '12:30'),
        Song('Canto de Paz', 'Healing Chants', 'assets/MUSICOTERAPIA/img_album9.jpg', '8:45'),
        Song('Energía Universal', 'Universal Energy', 'assets/MUSICOTERAPIA/img_album9.jpg', '15:20'),
      ],
    ),
    AlbumItem(
      'Frecuencias 432Hz',
      'Armonía para tu ser',
      'assets/MUSICOTERAPIA/img_album10.jpg',
      10,
      artist: 'Pure Harmony',
      songs: [
        Song('Armonía Perfecta', 'Pure Harmony', 'assets/MUSICOTERAPIA/img_album10.jpg', '20:30'),
        Song('Frecuencia del Universo', 'Cosmic Tune', 'assets/MUSICOTERAPIA/img_album10.jpg', '18:15'),
        Song('Resonancia Natural', 'Earth Frequency', 'assets/MUSICOTERAPIA/img_album10.jpg', '22:40'),
        Song('Alineación de Chakras', 'Energy Balance', 'assets/MUSICOTERAPIA/img_album10.jpg', '25:10'),
      ],
    ),
    AlbumItem(
      'Música para Yoga',
      ...
      artist: 'Yoga Flow',
      songs: [
        Song('Flow Consciente', 'Yoga Flow', 'assets/MUSICOTERAPIA/img_album11.jpg', '15:40'),
        Song('Equilibrio y Presencia', 'Present Yoga', 'assets/MUSICOTERAPIA/img_album11.jpg', '12:55'),
        Song('Energía Vital', 'Vital Energy', 'assets/MUSICOTERAPIA/img_album11.jpg', '14:30'),
        Song('Saludo al Sol', 'Sun Salutation', 'assets/MUSICOTERAPIA/img_album11.jpg', '18:25'),
      ],
    ),
  ];
