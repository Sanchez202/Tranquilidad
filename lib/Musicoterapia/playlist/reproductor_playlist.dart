...
class ReproductorPlaylistScreen extends StatefulWidget {
...
class _ReproductorPlaylistScreenState extends State<ReproductorPlaylistScreen> {
  ...
  void initState() {
    ...
    tracks = widget.tracks.cast<Map<String, dynamic>>();
              ...
              return SingleChildScrollView(
                child: ConstrainedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        // Back button and title - VOLVER A LA VISTA DE canciones_playlist.dart
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              IconButton(
                                ...
                                onPressed: () {
                                  // Navegar de vuelta a canciones_playlist con los datos de la playlist
                                  context.pop();
                                },
                              ),
                              const Text(
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          currentTrack['artist'] ?? widget.playlistCreator,
                                          style: const TextStyle(
                                            color: Colors.black,
                                            fontSize: 16,
                                          ),
