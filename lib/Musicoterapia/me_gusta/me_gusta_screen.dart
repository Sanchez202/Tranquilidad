...
class _MeGustaScreenState extends State<MeGustaScreen> {
  ...
  void initState() {
    ...
    songFavorites = List.generate(
      favoritesList.length,
      (index) => true,
    ); // Todas inician como favoritas
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            context.push(
                              '/reproductor_me_gusta',
                              extra: {'trackIndex': 0, 'tracks': filteredList},
                            );
                          },
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        leading: Container(
                          ...
                          clipBehavior:
                              Clip.antiAlias, // Ensures image clips properly
                          child: Image.asset(
                            song['image'],
                            fit: BoxFit.cover,
                            errorBuilder: (context, error, stackTrace) {
                              ...
                              debugPrint(
                                'Error loading image for track ${song['number']}: $error',
                              );
                              return Center(
                                child: Text(
                                  '${song['number']}',
                        ...
                        subtitle: Text(
                          ...
                          index % 3 == 0
                              ? 'Reading Time • ${song['duration']}'
                              : index % 3 == 1
                              ? 'Book Sounds • ${song['duration']}'
                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                ...
                                _showNotification(
                                  '"${song['title']}" ${songFavorites[index] ? 'añadido a Tus Me Gusta' : 'eliminado de Tus Me Gusta'}',
                                );
                              },
                            ),
