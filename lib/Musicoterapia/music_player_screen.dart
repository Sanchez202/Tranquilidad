...
class _MusicPlayerScreenState extends State<MusicPlayerScreen> {
  ...
  void _updateCurrentTime() {
    ...
    String fullDuration = widget.tracks[currentTrackIndex]['duration'] as String;
  ...
  void _toggleFavorite() {
    setState(() {
      ...
      if (isFavorite) {
        _showNotification('${widget.tracks[currentTrackIndex]['title']} añadido a favoritos');
      } else {
        _showNotification('${widget.tracks[currentTrackIndex]['title']} eliminado de favoritos');
      }
    });
  }
